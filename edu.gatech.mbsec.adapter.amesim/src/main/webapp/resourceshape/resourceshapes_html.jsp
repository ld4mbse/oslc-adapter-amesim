...
<title>AMESim OSLC Adapter: Resource Shapes</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">AMESim OSLC Adapter: Resource Shapes</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">Resource Shapes </span>AMESim</h1>
		<br>
		...
		<table>
			<tr>
				...
				<td><a href="<%= element.getAbout() %>"> <%=element.getTitle()%></a></td>
				<%i++;%>
