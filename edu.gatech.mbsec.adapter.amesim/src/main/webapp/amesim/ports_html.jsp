...
List<AMESimPort> elements = (List<AMESimPort>) request.getAttribute("elements");
...
<html>
	<head>
		...
		<title>AMESim OSLC Adapter: AMESim Ports</title>
	...
	<body onload="">
		...
		<div id="header">
			...
			<table border="0" cellspacing="10" cellpadding="0" id="titles">
				<tr>
					<td id="title">
						<p>
							AMESim OSLC Adapter: AMESim Ports
						</p>
					</td>
					<td id="information">
		...
		<div id="bugzilla-body">
			...
			<h1>AMESim Ports in Circuit <%= modelName %></h1>
			...
			<% for (AMESimPort amesimElement : elements) { %>			
