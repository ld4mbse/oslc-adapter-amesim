...
<%@ page import="edu.gatech.mbse.oslc4jamesim.resources.AMESimParameter" %>
<%@ page import="java.util.List" %>
<%
String bugzillaUri = (String) request.getAttribute("bugzillaUri");
List<AMESimParameter> elements = (List<AMESimParameter>) request.getAttribute("elements");
...
<html>
	<head>
		...
		<title>AMESim OSLC Adapter: AMESim Parameters</title>
	...
	<body onload="">
		...
		<div id="header">
			...
			<table border="0" cellspacing="10" cellpadding="0" id="titles">
				<tr>
					<td id="title">
						<p>
							AMESim OSLC Adapter: AMESim Parameters
						</p>
					</td>
					<td id="information">
		...
		<div id="bugzilla-body">
			...
			<h1>AMESim Parameters in Circuit <%= modelName %></h1>
			...
			<% for (AMESimParameter amesimElement : elements) { %>			
