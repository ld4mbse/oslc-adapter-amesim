...
AMESimLine line = (AMESimLine)request.getAttribute("element");
...
<html>
	<head>
		...
		<title>AMESim OSLC Adapter: AMESim Line</title>
	...
	<body onload="">
		...
		<div id="header">
			...
			<table border="0" cellspacing="10" cellpadding="0" id="titles">
				<tr>
					<td id="title">
						<p>
							AMESim OSLC Adapter: AMESim Line
						</p>
					</td>
					<td id="information">
		...
		<div id="bugzilla-body">
			...
			<h1><small>AMESim Line</small> <%= line.getName() %></h1>
			...
			<h2><small>SubModelName: <%= line.getSubModelName() %></small></h2>
			<h2><small>SubModelInstanceNumber: <%= line.getSubModelInstanceNumber() %></small></h2>
			<h2><small>SubModelDirectory: <%= line.getSubModelDirectory() %></small></h2>
