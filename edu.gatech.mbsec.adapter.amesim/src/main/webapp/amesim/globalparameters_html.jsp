...
<%@ page import="edu.gatech.mbsec.adapter.amesim.resources.AMESimGlobalParameter" %>
<%@ page import="java.util.List" %>
<%
String bugzillaUri = (String) request.getAttribute("bugzillaUri");
List<AMESimGlobalParameter> elements = (List<AMESimGlobalParameter>) request.getAttribute("elements");
...
<html>
	<head>
		...
		<title>AMESim OSLC Adapter: AMESim Global Parameters</title>
	...
	<body onload="">
		...
		<div id="header">
			...
			<table border="0" cellspacing="10" cellpadding="0" id="titles">
				<tr>
					<td id="title">
						<p>
							AMESim OSLC Adapter: AMESim Global Parameters
						</p>
					</td>
					<td id="information">
		...
		<div id="bugzilla-body">
			...
			<h1>AMESim Global Parameters in Circuit <%= modelName %></h1>
			...
			<% for (AMESimGlobalParameter amesimElement : elements) { %>			
