...
AMESimGlobalParameter element = (AMESimGlobalParameter)request.getAttribute("element");
...
<html>
	<head>
		...
		<title>AMESim OSLC Adapter: AMESim Global Parameter</title>
	...
	<body onload="">
		...
		<div id="header">
			...
			<table border="0" cellspacing="10" cellpadding="0" id="titles">
				<tr>
					<td id="title">
						<p>
							AMESim OSLC Adapter: AMESim Global Parameter
						</p>
					</td>
					<td id="information">
		...
		<div id="bugzilla-body">
			...
			<h1><small>AMESim Global Parameter</small> <%= element.getUniqueName() %></h1>
			...
			<h2><small>name: <%= element.getUniqueName() %></small></h2>						
