...
List<AMESimComponent> blocks = (List<AMESimComponent>) request.getAttribute("components");
...
<html>
	<head>
		...
		<title>AMESim OSLC Adapter: AMESim Components</title>
	...
	<body onload="">
		...
		<div id="header">
			...
			<table border="0" cellspacing="10" cellpadding="0" id="titles">
				<tr>
					<td id="title">
						<p>
							AMESim OSLC Adapter: AMESim Components
						</p>
					</td>
					<td id="information">
		...
		<div id="bugzilla-body">
			...
			<h1>AMESim Components in Circuit <%= modelName %></h1>
			...
			<% for (AMESimComponent amesimElement : blocks) { %>			
