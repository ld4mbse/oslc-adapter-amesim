...
public class AMESimPort extends AbstractResource{
	...
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Port_id")
	@OslcTitle("id")
	...
	@OslcName("type")
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Port_type")
	@OslcTitle("type")
	@OslcValueType(ValueType.XMLLiteral)
