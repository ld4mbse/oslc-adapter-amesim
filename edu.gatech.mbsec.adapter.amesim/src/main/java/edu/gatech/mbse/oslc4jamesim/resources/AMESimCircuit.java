...
public class AMESimCircuit extends AbstractResource{
	...
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Circuit_name")
	@OslcTitle("name")
	...
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Circuit_component")
	@OslcTitle("component")
	@OslcReadOnly(false)
	...
	@OslcName("line")
	@OslcOccurs(Occurs.ZeroOrMany)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Circuit_line")
	@OslcTitle("line")
	@OslcReadOnly(false)
	...
	@OslcOccurs(Occurs.ZeroOrMany)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Circuit_globalParameter")
