...
public class AMESimComponent extends AbstractResource{
	...
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Component_name")
	@OslcTitle("name")
	...
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Component_subModelName")
	...
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Component_subModelInstanceNumber")
	...
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Component_subModelDirectory")
	...
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Component_categoryName")
	...
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Component_xCoordinate")
	...
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Component_yCoordinate")
	...
	@OslcName("iconName")
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Component_iconName")
	@OslcTitle("iconName")
	@OslcValueType(ValueType.XMLLiteral)
	...
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Component_numberOfRotations")
	...
	@OslcName("isFlipped")
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Component_isFlipped")
	@OslcTitle("isFlipped")
	...
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Component_parameter")
	@OslcTitle("parameter")
	@OslcReadOnly(false)
	...
	@OslcName("port")
	@OslcOccurs(Occurs.ZeroOrMany)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Component_port")
	@OslcTitle("port")
	@OslcReadOnly(false)
	...
	@OslcOccurs(Occurs.ZeroOrMany)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Component_nestedComponent")
	...
	@OslcName("nestedLine")
	@OslcOccurs(Occurs.ZeroOrMany)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Component_nestedLine")
