...
public class AMESimGlobalParameter extends AbstractResource{
	...
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#GlobalParameter_uniqueName")
	...
	@OslcName("title")
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#GlobalParameter_title")
	@OslcTitle("title")
	@OslcValueType(ValueType.XMLLiteral)
	...
	// TODO: check why this property can have an invalid value
...
//	@OslcName("type")
//	@OslcOccurs(Occurs.ZeroOrOne)
//	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#GlobalParameter_type")
//	@OslcTitle("type")
...
//	}
	...
	@OslcName("value")
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#GlobalParameter_value")
	@OslcTitle("value")
	@OslcValueType(ValueType.XMLLiteral)
	...
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#GlobalParameter_defaultValue")
	...
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#GlobalParameter_minimalValue")
	...
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#GlobalParameter_maximalValue")
	...
	@OslcName("unit")
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#GlobalParameter_unit")
	@OslcTitle("unit")
	@OslcValueType(ValueType.XMLLiteral)
