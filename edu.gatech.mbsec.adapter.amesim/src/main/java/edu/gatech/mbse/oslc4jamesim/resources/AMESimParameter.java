...
public class AMESimParameter extends AbstractResource{
	...
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Parameter_value")
	@OslcTitle("value")
	...
	@OslcName("dataPath")
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Parameter_dataPath")
	@OslcTitle("dataPath")
	@OslcValueType(ValueType.XMLLiteral)
	...
	@OslcName("title")
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Parameter_title")
	@OslcTitle("title")
	@OslcValueType(ValueType.XMLLiteral)
	...
	@OslcName("unit")
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://localhost:8282/oslc4jamesim/services/rdfvocabulary#Parameter_unit")
	@OslcTitle("unit")
	@OslcValueType(ValueType.XMLLiteral)
