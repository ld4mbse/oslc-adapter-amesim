...
public class RDFVocabularyService {
	...
	public void getRDFVocabulary()
			...
			RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/rdfvocabulary/amesimRDFVocabulary.rdf");
			try {
	...
	public void getHtmlRDFVocabulary() throws OslcCoreApplicationException, URISyntaxException {
		...
		RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/rdfvocabulary/amesimRDFVocabulary.jsp");
		try {
			rd.forward(httpServletRequest, httpServletResponse);
		} catch (Exception e) {
			e.printStackTrace();
